...
class Announcement(models.Model):
    ...
    createddate = models.DateField(null=True, db_column='createdDate', blank=True, default=time.strftime('%Y-%m-%d'),
                                   verbose_name='Date')
...
class Products(models.Model):
    ...
    createddate = models.DateField(db_column='createdDate', blank=True, default=time.strftime('%Y-%m-%d'),
                                   verbose_name="Created Date")  # Field name made lowercase. This field type is a guess.
...
class News(models.Model):
    ...
    createddate = models.DateField(null=True, db_column='createdDate', blank=True, default=time.strftime('%Y-%m-%d'),
                                   verbose_name="Created Date")  # Field name made lowercase.
